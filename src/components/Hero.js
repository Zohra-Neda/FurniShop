...
const Hero = () => {
  ...
  return (
    ...
    pt-[200px] pb-[254px] relative mb-12 lg:bg-center lg:mb-28'>
      <div className='container mx-auto text-center'>
        ...
        <button className='bg-[rgb(255,255,255,0.4)] hover:bg-[rgb(255,255,255,0.5)] px-[35px] py-[9px] mb-[160px] text-xl rounded-md backdrop-blur-md transition lg:px-[80px] lg:py-[16px] lg:mb-[194px]'>{buttonText}</button>
